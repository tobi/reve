...
module Reve
  ...
  module Prompt
    ...
    def system_prompt(cwd: Dir.pwd, tools: nil, agents: nil, skills: nil, goal: nil, append: nil)
      ...
      prompt = +<<~TXT.strip
        You are an expert coding assistant operating inside reve, a durable coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
